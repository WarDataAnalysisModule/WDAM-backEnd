...
public interface UserRepository extends JpaRepository<Users, Long> {
    ...
    @Modifying
    @Transactional
    @Query("update Users u set u.userName = :userName, u.phone = :phone, u.email = :email where u.userIdx = :userIdx")
    void updateByUserIdx(@Param("userName") String userId, @Param("phone") String phone, @Param("email") String email, @Param("userIdx") Long userIdx);
